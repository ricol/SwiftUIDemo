...
struct ScrollableSegmentsControl: View {
    ...
    struct ScrollableSegmentMainView: View {
        @ObservedObject var vm: ScrollableSegmentsControl.ViewModel
    ...
    struct ScrollSegementView: View {
        let vm: ScrollableSegmentsControl.ViewModel
        var body: some View {
    ...
    struct SegmentView: View {
        @ObservedObject var model: ScrollableSegmentsControl.SegmentModel
        let vm: ScrollableSegmentsControl.ViewModel
        ...
        var body: some View {
            ZStack {
                ...
                .buttonStyle(ScrollableSegmentsControl.NoHighlightButtonStyle())
            }
        }
    }
}
...
class ScrollableSegmentsHostingController: UIHostingController<ScrollableSegmentsControl> {
    private let vm = ScrollableSegmentsControl.ViewModel(data: [])
    init(segments: [ScrollableSegmentsControl.SegmentModel] = [],
         height: CGFloat = 32,
         paddingVertical: CGFloat = 0,
         paddingHorizonal: CGFloat = 12) {
        vm.data = segments
    ...
    func addSegment(s: ScrollableSegmentsControl.SegmentModel) {
        vm.data.append(s)
    }
}
...
#Preview {
    let data = [
        ScrollableSegmentsControl.SegmentModel(value: "AI Conversations",
                     bgHighlightGradientColors: [.red, .blue],
                     borderHightLightColor: .clear,
                     bgColor: .clear,
                     bgHighlightColor: .clear),
        ScrollableSegmentsControl.SegmentModel(value: "Private class"),
        ScrollableSegmentsControl.SegmentModel(value: "Public class"),
        ScrollableSegmentsControl.SegmentModel(value: "Others")
    ]
    ScrollableSegmentsControl(vm: ScrollableSegmentsControl.ViewModel(data: data))
}
